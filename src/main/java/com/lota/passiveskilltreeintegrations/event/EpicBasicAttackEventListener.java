...
/**
 * Event listener that triggers when a player performs a basic attack in Epic Fight.
 */
public class EpicBasicAttackEventListener implements SkillEventListener {
    ...
    public SkillEventListener.Serializer getSerializer() {
        return EFSTEventListeners.EPIC_BASIC_ATTACK.get();
    }
    ...
    public boolean equals(Object o) {
        ...
        EpicBasicAttackEventListener listener = (EpicBasicAttackEventListener) o;
    ...
    public static class Serializer implements SkillEventListener.Serializer {
        ...
        public SkillEventListener deserialize(JsonObject json) throws JsonParseException {
            EpicBasicAttackEventListener listener = new EpicBasicAttackEventListener();
        ...
        public void serialize(JsonObject json, SkillEventListener listener) {
            if (!(listener instanceof EpicBasicAttackEventListener aListener)) throw new IllegalArgumentException();
        ...
        @Override
        public SkillEventListener createDefaultInstance() { return new EpicBasicAttackEventListener(); }
    }
}
